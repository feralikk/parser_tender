...
def parse(url):
    ...
    while page != 0:
        ...
        if response.status_code == 200:
            ...
            records = soup.find_all("a", "news-item")
            for record in records:
                title = record.find("div", "news-item__title")
                link = "https://mb.tomsk.ru" + record.get('href')
                date_string = record.find("div", "event-item__date").text
