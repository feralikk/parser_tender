...
def parse(url):
    ...
    while page != 0:
        ...
        if response.status_code == 200:
            ...
            records_list = []
            records = soup.find_all("div", "main-news-line__item h-100")
            for record in records:
                title = record.find("div", "main-news-line__item_title")
                link = "https://export.mbpenza.ru" + title.find('a').get('href')
                date_string = record.find("div", "main-news-line__item_date").text
